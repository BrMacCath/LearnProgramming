...
```dataview 
TABLE WITHOUT ID
file.link as "Research Task",
file.frontmatter.taskStatus  AS "Task Status",
file.frontmatter.due_date AS "Due Date"
FROM "Scripts/Week_1 Rust/Tasks"
WHERE file.frontmatter.taskType = "Research"
```


```dataview 
TABLE WITHOUT ID
file.link as "Recording Task",
file.frontmatter.taskStatus  AS "Task Status",
file.frontmatter.due_date AS "Due Date"
FROM "Scripts/Week_1 Rust/Tasks"
WHERE file.frontmatter.taskType = "Recording"
```

```dataview 
TABLE WITHOUT ID
file.link as "Script Task",
file.frontmatter.taskStatus  AS "Task Status",
file.frontmatter.due_date AS "Due Date"
FROM "Scripts/Week_1 Rust/Tasks"
WHERE file.frontmatter.taskType = "Script"
```
